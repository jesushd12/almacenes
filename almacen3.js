...
eurecaServer.exports.hello = function (llegoHormiguita) {
    ...
    console.log('Almacen 3 - Hormiga enviada > Tipo de comida: '+hormiga.obtenerTipoComida+' Cantidad: '+hormiga.obtenerEncomienda+' Itinerario'+hormiga.obtenerItinerario + ' Hormiga peso MAX ' + hormiga.obtenerPesoMaximo);
    ...
    if(hormiga.buscarProximoDestino()){
        ...
        .then(function(result){
            ...
            return  new Promise (function (resolve, reject){
                console.log(' IF  Almacen 3 - Hormiga antes de regresar PESO MAX' + hormigaResultado.obtenerPesoMaximo);
        ...
        console.log(' ELSE almacen 3 - Hormiga antes de regresar ' + hormiga + 'valor peso maximo de la hormiga' + hormiga.obtenerPesoMaximo);
        return new Promise (function (resolve, reject){
